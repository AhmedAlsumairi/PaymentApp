...
<body>
 <div class="container">
    ...
    <form id="loginFormDiv" class="loginForm"  action="RegisterSrvlt" method="post">
		...
		<div class="form-controll">
			...
			<!-- <input type="password"  class="control-enter" id="Role" name="Role" placeholder="Role" /> -->
            <select name="role" id="cars" class="role">
              <option value="admin">Admin</option>
              <option value="user">User</option>
            </select>
		</div>
		<div>
			<input type="submit" class="Login-submit" value="Register" onclick="login()" />
		</div>
	   </form>
</body>
</html>